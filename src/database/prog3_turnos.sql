...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2026 a las 21:24:44
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_estadisticas_por_especialidad` ()   BEGIN
    SELECT 
        ...
        SUM(tr.valor_total) AS ingresos_totales
    FROM especialidades e
    INNER JOIN medicos m ON m.id_especialidad = e.id_especialidad
    INNER JOIN turnos_reservas tr ON tr.id_medico = m.id_medico
    WHERE tr.activo = 1
    GROUP BY e.id_especialidad, e.nombre;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_estadisticas_turnos` ()   BEGIN
    SELECT 
...
(5, 14, 2, 5000, 'Médico de prueba Clínica', 7000.00, 1),
(6, 16, 9, 6000, 'Médico Neurología', 12000.00, 1),
(8, 14, 2, 9001, 'Médico Clínica', 7000.00, 1),
(9, 16, 9, 9002, 'Médico Neurología', 12000.00, 1);
...
(8, 1, 1, 1, '2026-05-01 09:00:00', 4500.00, 1, 1),
(9, 2, 2, 2, '2026-05-02 10:00:00', 9000.00, 1, 1),
(10, 3, 3, 3, '2026-05-03 11:00:00', 13350.00, 0, 1),
(11, 4, 1, 1, '2026-05-04 14:00:00', 13350.00, 1, 1),
(12, 1, 2, 2, '2026-05-05 15:00:00', 4500.00, 0, 1),
(13, 2, 3, 3, '2026-05-06 09:30:00', 9000.00, 1, 1),
(14, 3, 1, 1, '2026-05-07 10:30:00', 13350.00, 0, 1),
(15, 4, 2, 2, '2026-05-08 11:30:00', 13350.00, 1, 1),
(16, 5, 1, 1, '2026-05-10 09:00:00', 6300.00, 1, 1),
(17, 5, 2, 2, '2026-05-11 10:00:00', 6300.00, 1, 1),
(18, 5, 3, 3, '2026-05-12 11:00:00', 6230.00, 1, 1),
(19, 6, 1, 1, '2026-05-13 09:00:00', 10800.00, 0, 1),
(20, 6, 2, 2, '2026-05-14 10:00:00', 10800.00, 1, 1),
(21, 6, 3, 3, '2026-05-15 11:00:00', 10680.00, 0, 1);
...
(13, '99000001', 'Test', 'Test', 'admin@test.com', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '', 3, 1),
(14, '99000002', 'Test', 'Medico', 'medico@test.com', '673ab82a6530ee3bd9b04ee72a4d66afa7fa059aedc685cf44e35d29d90ebafa', '', 1, 1),
(15, '99000003', 'Test', 'Paciente', 'paciente@test.com', '299fbb455c42239c86d2ee3b15403ed1b468259ecaedf0c3527451e1f0d63d59', '', 2, 1),
(16, '99000004', 'Test', 'Neurologo', 'neurologo@test.com', '673ab82a6530ee3bd9b04ee72a4d66afa7fa059aedc685cf44e35d29d90ebafa', '', 1, 1);
...
--
ALTER TABLE `turnos_reservas`
  MODIFY `id_turno_reserva` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
